$(document).ready(function () {
  ...
  $("#thumbnail").click(function () {
    ...
    $(".testimonial-holder").slick({
      ...
      pauseOnFocus: !1,
      prevArrow:
        "<button aria-label='Slider Arrow Left' type='button' class='slick-prev pull-left'><svg width='24' height='25' viewBox='0 0 24 25' fill='none' xmlns='http://www.w3.org/2000/svg'><g id='chevron-left'><path id='Icon' d='M15 18.9326L9 12.9326L15 6.93262' stroke='#71717A' stroke-width='1.8' stroke-linecap='round' stroke-linejoin='round'/></g></svg> </button>",
      nextArrow:
        "<button aria-label='Slider Arrow Right' type='button' class='slick-next pull-right'><svg width='24' height='25' viewBox='0 0 24 25' fill='none' xmlns='http://www.w3.org/2000/svg'><g id='chevron-left'><path id='Icon' d='M9 18.9326L15 12.9326L9 6.93262' stroke='#71717A' stroke-width='1.8' stroke-linecap='round' stroke-linejoin='round'/></g></svg></button>",
    });
  function i(e, _) {
    let t = $(e),
      i = t.find(".pager"),
